...
<body class="quotation_body" onload="window.print()">
    ...
    <section class="header_section">
        ...
        <div class="row">
            <div class="col-md-3">
                <h4 style="color: #020802;">Quotation</h4>
                <div class="row">
                    <div class="col-md-6">
    ...
    <section style="margin: 5px 0;" class="information_section">
        ...
        <div class="row">
            <div class="col-md-5 rounded" style="background: #EFEAF8;">
                <h4 style="color: #020802;">Quotation From</h4>
            ...
            <div class="col-md-5 rounded" style="background: #EFEAF8;">
                <h4 style="color: #020802;">Quotation To</h4>
    ...
    <section class="items_part mt-2">
        <div class="row rounded" style="background: #020802;">
    ...
    <section class="terms_part mt-2">
        ...
        <h5 style="color: #020802;">Terms and Conditions</h5>
        <?php
